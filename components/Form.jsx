...
const Form = ({ type, work, setWork, handleSubmit }) => {
  ...
  return (
    <div className="form">
      <h1>{type} Your Art Work</h1>
      <form onSubmit={handleSubmit}>
        <h3>Which of these categories best describes your Art Work?</h3>
        ...
        <h3>What makes your art work standout?</h3>
        ...
        <button className="submit_btn" type="submit">UPLOAD YOUR ART WORK</button>
      </form>
    </div>
  );
};
